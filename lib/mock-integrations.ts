...
export const MOCK_INTEGRATIONS_DATA: Integration[] = [
  {
    ...
    description: 'API oficial do WhatsApp Business via Meta. Requer verificação Meta, oferece máxima confiabilidade e recursos avançados.',
    logo: '/integrations/whatsapp.svg',
    color: '#25D366',
    category: 'whatsapp',
    authMethod: 'oauth',
    status: 'not_connected',
    features: ['API Oficial Meta', 'Templates', 'Mensagens em Massa', 'Verificação Green Tick', 'Webhooks'],
    messagesCount: 0,
  ...
  },
  {
    ...
    slug: 'whatsapp-nao-oficial',
    description: 'Integração via API não oficial (Evolution API/WhatsApp Web). Conexão rápida via QR Code, sem necessidade de verificação Meta.',
    logo: '/integrations/whatsapp.svg',
    color: '#25D366',
    category: 'whatsapp',
    authMethod: 'api_key',
    status: 'connected',
    features: ['Mensagens', 'Mídia', 'Templates', 'Webhooks', 'QR Code'],
    messagesCount: 1247,
...
export const MOCK_ACTIVITY_LOGS_DATA: ActivityLog[] = [
  {
    id: 'log-1',
    integrationId: 'whatsapp-nao-oficial',
    integrationName: 'WhatsApp Não Oficial',
