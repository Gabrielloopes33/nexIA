...
export const MOCK_AI_INSIGHTS: AIInsight[] = [
  ...
  },
  {
    ...
    description: 'Leads com múltiplos touchpoints e ciclo de vendas avançado',
    priority: 'high',
  ...
  },
  {
    id: 'rec-3',
    type: 'recomendacoes',
    title: 'Implementar sequência automática para leads engajados',
    description: 'Leads com alto engajamento respondem bem a cadências de 5 touchpoints',
    priority: 'medium',
