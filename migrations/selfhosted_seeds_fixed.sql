-- Seeds para Supabase Self-Hosted (CORRIGIDO - Idempotente)
...
INSERT INTO pipeline_templates (id, name, description, is_default, created_at, updated_at)
VALUES 
  (
...
-- ============================================
-- 4. TIPOS DE INTEGRAÇÕES (Tabela auxiliar)
-- ============================================
