        ...
        <div className="mb-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <QuickAction
              ...
              icon={Phone}
              href="/meta-api/whatsapp/numeros"
            ...
            <QuickAction
              ...
              icon={FileText}
              href="/meta-api/whatsapp/templates"
              disabled={!isConnected}
            />
          </div>
        </div>
                ...
                {!isConnected ? (
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <Button size="sm" variant="link" className="h-auto p-0 text-[#46347F]" asChild>
                      <Link href="/meta-api/whatsapp/connect">Ir</Link>
                    </Button>
                  </li>
                ) : (
                  <>
                    ...
                    <li className="flex items-center gap-2 text-sm">
                      ...
                      <Button size="sm" variant="link" className="h-auto p-0 text-[#46347F]" asChild>
                        <Link href="/meta-api/whatsapp/webhooks">Configurar</Link>
                      </Button>
                    </li>
                    <li className="flex items-center gap-2 text-sm">
                      <div className="h-2 w-2 rounded-full bg-[#46347F]" />
                      ...
                      <Button size="sm" variant="link" className="h-auto p-0 text-[#46347F]" asChild>
                        <Link href="/meta-api/whatsapp/templates">Criar</Link>
                      </Button>
                    </li>
                  </>
                )}
