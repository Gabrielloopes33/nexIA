-- ============================================
-- RESET E RECRIAÇÃO COMPLETA DO SCHEMA
-- USE COM CUIDADO - APAGA TODOS OS DADOS
-- ============================================

-- Desativar verificação de FKs temporariamente
SET session_replication_role = 'replica';

-- Dropar todas as tabelas do Sprint 1 (se existirem)
DROP TABLE IF EXISTS "contact_custom_field_values" CASCADE;
...
-- Dropar tabelas base (se existirem)
