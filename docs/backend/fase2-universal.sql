-- ============================================================================
-- FASE 2 - Row Level Security (RLS) - VERSÃO UNIVERSAL
-- ============================================================================
-- Converte ambos os lados para text (funciona com uuid e text)
-- ============================================================================
...
-- ============================================================================
-- PARTE 2: FUNÇÃO UNIVERSAL (aceita qualquer tipo e converte para text)
-- ============================================================================
...
BEGIN
    IF current_setting('app.current_org_id', true) IS NULL THEN
        RETURN FALSE;
    END IF;
    RETURN org_id = current_setting('app.current_org_id', true);
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;

-- Sobrecarga para uuid
...
BEGIN
    IF current_setting('app.current_org_id', true) IS NULL THEN
        RETURN FALSE;
    END IF;
    RETURN org_id::text = current_setting('app.current_org_id', true);
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
