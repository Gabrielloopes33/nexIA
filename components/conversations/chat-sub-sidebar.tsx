...
const channelsNavItems: NavItem[] = [
  ...
  { label: "Instagram", href: "/conversas/channels/instagram", icon: Instagram },
  { label: "Chat Widget", href: "/conversas/channels/chat-widget", icon: Globe },
]

// Etiquetas removidas conforme solicitação
...
export function ChatSubSidebar() {
  ...
  return (
    <aside className="h-full w-[220px] border-r border-border bg-background">
