  ...
  return (
    <header className="flex items-start justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Notifications */}
        <button className="relative flex h-8 items-center justify-center gap-2 rounded-sm bg-card px-3 text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground">
          <Bell className="h-4 w-4" />
          <span className="text-xs">Alertas</span>
          <span className="absolute -right-0.5 -top-0.5 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[#DC2626] text-[9px] font-bold text-white">
            3
          </span>
        </button>
