-- ============================================
-- SUPABASE: Adaptação para schema existente
-- NÃO altera tabelas do Supabase Auth
-- ============================================
...
-- 3. Adicionar colunas faltantes em organizations
DO $$
BEGIN
...
-- 4. Adicionar colunas faltantes em contacts (adaptado para schema existente)
DO $$
BEGIN
...
-- Criar índice para deleted_at (soft delete)
...
-- Tabela: organization_members (se não existir)
